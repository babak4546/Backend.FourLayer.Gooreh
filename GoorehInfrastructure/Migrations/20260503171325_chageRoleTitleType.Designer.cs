...
namespace GoorehInfrastructure.Migrations
{
    ...
    [Migration("20260503171325_chageRoleTitleType")]
    partial class chageRoleTitleType
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("GoorehDomain.Entities.Role", b =>
                {
                    ...
                    b.Property<int>("RoleTitleId")
                        .HasColumnType("int");

                    b.HasKey("Id");

                    b.HasIndex("RoleTitleId");
            ...
            modelBuilder.Entity("GoorehDomain.Entities.Role", b =>
                {
                    b.HasOne("GoorehDomain.Entities.UserLogData", "RoleTitle")
                        .WithMany()
                        .HasForeignKey("RoleTitleId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.Navigation("RoleTitle");
                });
